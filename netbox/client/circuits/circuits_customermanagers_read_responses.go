...
func (o *CircuitsCustomermanagersReadReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCircuitsCustomermanagersReadOK()
...
func NewCircuitsCustomermanagersReadOK() *CircuitsCustomermanagersReadOK {
	return &CircuitsCustomermanagersReadOK{}
}
...
func (o *CircuitsCustomermanagersReadOK) Error() string {
	return fmt.Sprintf("[GET /circuits/customermanagers/{id}/][%d] circuitsCustomermanagersReadOK  %+v", 200, o.Payload)
}

func (o *CircuitsCustomermanagersReadOK) GetPayload() *models.CustomerManager {
	return o.Payload
}

func (o *CircuitsCustomermanagersReadOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
