...
// Validate validates this customer manager
func (m *CustomerManager) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CustomerManager) validateEmail(formats strfmt.Registry) error {
...
func (m *CustomerManager) validateName(formats strfmt.Registry) error {
...
func (m *CustomerManager) validatePhone(formats strfmt.Registry) error {
...
func (m *CustomerManager) validateSlug(formats strfmt.Registry) error {
