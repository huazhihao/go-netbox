...
// Validate validates this device department
func (m *DeviceDepartment) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DeviceDepartment) validateName(formats strfmt.Registry) error {
...
func (m *DeviceDepartment) validateSlug(formats strfmt.Registry) error {
