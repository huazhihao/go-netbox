...
func (o *CircuitsCustomermanagersUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCircuitsCustomermanagersUpdateOK()
...
func NewCircuitsCustomermanagersUpdateOK() *CircuitsCustomermanagersUpdateOK {
	return &CircuitsCustomermanagersUpdateOK{}
}
...
func (o *CircuitsCustomermanagersUpdateOK) Error() string {
	return fmt.Sprintf("[PUT /circuits/customermanagers/{id}/][%d] circuitsCustomermanagersUpdateOK  %+v", 200, o.Payload)
}

func (o *CircuitsCustomermanagersUpdateOK) GetPayload() *models.CustomerManager {
	return o.Payload
}

func (o *CircuitsCustomermanagersUpdateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
