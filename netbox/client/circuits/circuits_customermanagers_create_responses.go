...
func (o *CircuitsCustomermanagersCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		result := NewCircuitsCustomermanagersCreateCreated()
...
func NewCircuitsCustomermanagersCreateCreated() *CircuitsCustomermanagersCreateCreated {
	return &CircuitsCustomermanagersCreateCreated{}
}
...
func (o *CircuitsCustomermanagersCreateCreated) Error() string {
	return fmt.Sprintf("[POST /circuits/customermanagers/][%d] circuitsCustomermanagersCreateCreated  %+v", 201, o.Payload)
}

func (o *CircuitsCustomermanagersCreateCreated) GetPayload() *models.CustomerManager {
	return o.Payload
}

func (o *CircuitsCustomermanagersCreateCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
