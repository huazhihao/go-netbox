...
func (o *CircuitsCustomermanagersDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewCircuitsCustomermanagersDeleteNoContent()
...
func NewCircuitsCustomermanagersDeleteNoContent() *CircuitsCustomermanagersDeleteNoContent {
	return &CircuitsCustomermanagersDeleteNoContent{}
}
...
func (o *CircuitsCustomermanagersDeleteNoContent) Error() string {
	return fmt.Sprintf("[DELETE /circuits/customermanagers/{id}/][%d] circuitsCustomermanagersDeleteNoContent ", 204)
}

func (o *CircuitsCustomermanagersDeleteNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
