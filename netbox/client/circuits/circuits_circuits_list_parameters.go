...
func (o *CircuitsCircuitsListParams) WithCustomermanager(customermanager *string) *CircuitsCircuitsListParams {
	o.SetCustomermanager(customermanager)
	return o
}
...
func (o *CircuitsCircuitsListParams) SetCustomermanager(customermanager *string) {
	o.Customermanager = customermanager
}
...
func (o *CircuitsCircuitsListParams) WithCustomermanagerID(customermanagerID *string) *CircuitsCircuitsListParams {
	o.SetCustomermanagerID(customermanagerID)
	return o
}
...
func (o *CircuitsCircuitsListParams) SetCustomermanagerID(customermanagerID *string) {
	o.CustomermanagerID = customermanagerID
}
...
func (o *CircuitsCircuitsListParams) WithPaymentCircle(paymentCircle *string) *CircuitsCircuitsListParams {
	o.SetPaymentCircle(paymentCircle)
	return o
}
...
func (o *CircuitsCircuitsListParams) WithRedundancyType(redundancyType *string) *CircuitsCircuitsListParams {
	o.SetRedundancyType(redundancyType)
	return o
}
...
func (o *CircuitsCircuitsListParams) WithVendorInterfaceType(vendorInterfaceType *string) *CircuitsCircuitsListParams {
	o.SetVendorInterfaceType(vendorInterfaceType)
	return o
}
...
func (o *CircuitsCircuitsListParams) SetVendorInterfaceType(vendorInterfaceType *string) {
	o.VendorInterfaceType = vendorInterfaceType
}
...
func (o *CircuitsCircuitsListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Customermanager != nil {

		// query param customermanager
		var qrCustomermanager string
		if o.Customermanager != nil {
			qrCustomermanager = *o.Customermanager
		}
		qCustomermanager := qrCustomermanager
		if qCustomermanager != "" {
			if err := r.SetQueryParam("customermanager", qCustomermanager); err != nil {
				return err
			}
		}
	...
	if o.CustomermanagerID != nil {

		// query param customermanager_id
		var qrCustomermanagerID string
		if o.CustomermanagerID != nil {
			qrCustomermanagerID = *o.CustomermanagerID
		}
		qCustomermanagerID := qrCustomermanagerID
		if qCustomermanagerID != "" {
			if err := r.SetQueryParam("customermanager_id", qCustomermanagerID); err != nil {
				return err
			}
		}
	...
	if o.PaymentCircle != nil {

		// query param payment_circle
		var qrPaymentCircle string
		if o.PaymentCircle != nil {
			qrPaymentCircle = *o.PaymentCircle
		}
		qPaymentCircle := qrPaymentCircle
		if qPaymentCircle != "" {
			if err := r.SetQueryParam("payment_circle", qPaymentCircle); err != nil {
				return err
			}
		}
	...
	if o.RedundancyType != nil {

		// query param redundancy_type
		var qrRedundancyType string
		if o.RedundancyType != nil {
			qrRedundancyType = *o.RedundancyType
		}
		qRedundancyType := qrRedundancyType
		if qRedundancyType != "" {
			if err := r.SetQueryParam("redundancy_type", qRedundancyType); err != nil {
				return err
			}
		}
	...
	if o.VendorInterfaceType != nil {

		// query param vendor_interface_type
		var qrVendorInterfaceType string
		if o.VendorInterfaceType != nil {
			qrVendorInterfaceType = *o.VendorInterfaceType
		}
		qVendorInterfaceType := qrVendorInterfaceType
		if qVendorInterfaceType != "" {
			if err := r.SetQueryParam("vendor_interface_type", qVendorInterfaceType); err != nil {
				return err
			}
		}
