...
// NewCircuitsCustomermanagersListParams creates a new CircuitsCustomermanagersListParams object
// with the default values initialized.
func NewCircuitsCustomermanagersListParams() *CircuitsCustomermanagersListParams {
	var ()
	return &CircuitsCustomermanagersListParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewCircuitsCustomermanagersListParamsWithTimeout creates a new CircuitsCustomermanagersListParams object
...
// NewCircuitsCustomermanagersListParamsWithContext creates a new CircuitsCustomermanagersListParams object
...
// NewCircuitsCustomermanagersListParamsWithHTTPClient creates a new CircuitsCustomermanagersListParams object
...
/*CircuitsCustomermanagersListParams contains all the parameters to send to the API endpoint
for the circuits customermanagers list operation typically these are written to a http.Request
*/
...
func (o *CircuitsCustomermanagersListParams) WithTimeout(timeout time.Duration) *CircuitsCustomermanagersListParams {
...
func (o *CircuitsCustomermanagersListParams) WithContext(ctx context.Context) *CircuitsCustomermanagersListParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the circuits customermanagers list params
func (o *CircuitsCustomermanagersListParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the circuits customermanagers list params
func (o *CircuitsCustomermanagersListParams) WithHTTPClient(client *http.Client) *CircuitsCustomermanagersListParams {
...
func (o *CircuitsCustomermanagersListParams) WithEmail(email *string) *CircuitsCustomermanagersListParams {
	o.SetEmail(email)
	return o
}
...
func (o *CircuitsCustomermanagersListParams) WithLimit(limit *int64) *CircuitsCustomermanagersListParams {
	o.SetLimit(limit)
	return o
}
...
func (o *CircuitsCustomermanagersListParams) WithName(name *string) *CircuitsCustomermanagersListParams {
	o.SetName(name)
	return o
}
...
func (o *CircuitsCustomermanagersListParams) WithOffset(offset *int64) *CircuitsCustomermanagersListParams {
	o.SetOffset(offset)
	return o
}
...
func (o *CircuitsCustomermanagersListParams) WithPhone(phone *string) *CircuitsCustomermanagersListParams {
	o.SetPhone(phone)
	return o
}
...
func (o *CircuitsCustomermanagersListParams) WithQ(q *string) *CircuitsCustomermanagersListParams {
	o.SetQ(q)
	return o
}

// SetQ adds the q to the circuits customermanagers list params
func (o *CircuitsCustomermanagersListParams) SetQ(q *string) {
	o.Q = q
}

// WithSlug adds the slug to the circuits customermanagers list params
func (o *CircuitsCustomermanagersListParams) WithSlug(slug *string) *CircuitsCustomermanagersListParams {
	o.SetSlug(slug)
	return o
}
...
func (o *CircuitsCustomermanagersListParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
